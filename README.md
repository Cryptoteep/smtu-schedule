...
2. **Академический календарь и четность недель**:
   - Автоматический расчет текущей учебной недели и четности: **Верхняя неделя** / **Нижняя неделя**.
   - Фильтрация: *Текущая неделя*, *Верхняя*, *Нижняя*, *Все недели*.
...
5. **Расписание и профили 664 преподавателей**:
   - Полная база профессорско-преподавательского состава СПбГМТУ (664 преподавателя).
   - Индивидуальные расписания всех преподавателей, поиск по фамилии, нагрузка и объединение потоковых пар.
   - Прямые ссылки на официальные профили `www.smtu.ru/ru/viewperson/<id>/`.
   - Двусторонняя навигация: переключение между расписанием преподавателя и учебных групп в один клик.
